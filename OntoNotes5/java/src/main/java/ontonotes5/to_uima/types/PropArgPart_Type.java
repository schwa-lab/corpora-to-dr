 ...
 * @generated */
public class PropArgPart_Type extends AnnotationBase_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (PropArgPart_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = PropArgPart_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new PropArgPart(addr, PropArgPart_Type.this);
  			   PropArgPart_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new PropArgPart(addr, PropArgPart_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = PropArgPart.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("ontonotes5.to_uima.types.PropArgPart");
  ...
  public String getEncoded(int addr) {
      ...
      jcas.throwFeatMissing("encoded", "ontonotes5.to_uima.types.PropArgPart");
  ...
  public int getNode(int addr) {
      ...
      jcas.throwFeatMissing("node", "ontonotes5.to_uima.types.PropArgPart");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public PropArgPart_Type(JCas jcas, Type casType) {
    super(jcas, casType);
