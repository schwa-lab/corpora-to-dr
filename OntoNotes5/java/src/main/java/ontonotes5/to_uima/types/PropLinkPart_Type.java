 ...
 * @generated */
public class PropLinkPart_Type extends AnnotationBase_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (PropLinkPart_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = PropLinkPart_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new PropLinkPart(addr, PropLinkPart_Type.this);
  			   PropLinkPart_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new PropLinkPart(addr, PropLinkPart_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = PropLinkPart.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("ontonotes5.to_uima.types.PropLinkPart");
  ...
  public String getEncoded(int addr) {
      ...
      jcas.throwFeatMissing("encoded", "ontonotes5.to_uima.types.PropLinkPart");
  ...
  public int getNode(int addr) {
      ...
      jcas.throwFeatMissing("node", "ontonotes5.to_uima.types.PropLinkPart");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public PropLinkPart_Type(JCas jcas, Type casType) {
    super(jcas, casType);
